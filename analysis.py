...
if(len(jobs)%2==0):
    print("Median time taken by tasks in LL",jobs[int(len(jobs)/2)])
else:
    print("Median time taken by tasks LL",jobs[int((len(jobs)+1)/2)])
...
plt.plot(list(range(1,len(tasks)+1)), tasks)
plt.xlabel('Tasks')
plt.ylabel('Time(sec)')
...
if(len(jobs)%2==0):
    print("Median time taken by tasks RR",jobs[int(len(jobs)/2)])
else:
    print("Median time taken by tasks RR",jobs[int((len(jobs)+1)/2)])
...
if(len(jobs)%2==0):
    print("Median time taken by tasks in RANDOM",jobs[int(len(jobs)/2)])
else:
    print("Median time taken by tasks in RANDOM",jobs[int((len(jobs)+1)/2)])
